...
public interface UserService {
    ...
    HashMap<String, Double> userGetActualCourse(String secret_key, String currency);
    HashMap<String, String> userExchangeValue(String secret_key, String currencyFrom, String currencyTo, Double amount);
}
